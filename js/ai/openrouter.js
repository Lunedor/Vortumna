...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const DEFAULT_MODELS = [
		...
		{ name: 'microsoft/phi-4-reasoning-plus:free', displayName: 'Phi 4 Reasoning Plus' },
		{ name: 'google/gemini-2.5-pro-exp-03-25', displayName: 'Gemini 2.5 Pro' },
		{ name: 'google/gemini-2.0-flash-exp:free', displayName: 'Gemini 2.0 Flash' },
